...
c
c  File:        nodediffusionstencilcoeffs2d.m4
...
c  Description: F77 routines that compute matrix entries for 2d node centered diffusion solver.
c
define(NDIM,2)dnl
...
c
c
      recursive subroutine nodediffusionoffdiag2d(
...
c
     ...
     &  b1(FACE2d1(bilo,bihi,0))
      ...
      REAL stencil(0:4, CELL2d(ifirst,ilast,0))
...
c     
      recursive subroutine nodepoissonoffdiag2d(
     &  ifirst0,ifirst1,ilast0,ilast1,
     &  dx,
     &  beta,
     &  stencil)
...
c
c
      recursive subroutine nodediffusionv1diag2d(
     &  ifirst0,ifirst1,ilast0,ilast1,
...
c
c     
      recursive subroutine nodediffusionv2diag2d(
     &  ifirst0,ifirst1,ilast0,ilast1,
     &  alpha,
     &  stencil)
c***********************************************************************
...
c
c     
      recursive subroutine nodepoissondiag2d(
     &  ifirst0,ifirst1,ilast0,ilast1,
     &  stencil)
c***********************************************************************
      implicit none
...
c
c
      recursive subroutine adjnodediffusiondiag2d(
     &  ifirst0,ifirst1,ilast0,ilast1,
...
c
      ...
      recursive subroutine adjnodepoissondiag2d(
     &  ifirst0,ifirst1,ilast0,ilast1,
     &  pfirst0,pfirst1,plast0,plast1,
     &  direction, side,
     &  bdrytype,
...
c
      ...
      recursive subroutine adjnodediffusioncfdiag2d(
     &  ifirst0,ifirst1,ilast0,ilast1,
     &  pfirst0,pfirst1,plast0,plast1,
     &  r,
     &  direction, side,
...
c
     ...
     &  b1(FACE2d1(ifirst,ilast,0))
      REAL
     &  stencil(0:4,CELL2d(ifirst,ilast,0))
      integer ic0,ic1,ie0,ie1, edge
...
c
      recursive subroutine adjnodepoissoncfdiag2d(
     &  ifirst0,ifirst1,ilast0,ilast1,
     &  pfirst0,pfirst1,plast0,plast1,
     &  r,
     &  direction, side,
...
c
c
      recursive subroutine adjnodediffusionoffdiag2d(
     &  ifirst0,ifirst1,ilast0,ilast1,
     &  pfirst0,pfirst1,plast0,plast1,
     &  direction, side,
     &  bdrytype,
...
c
      recursive subroutine adjnodepoissonoffdiag2d(
     &  ifirst0,ifirst1,ilast0,ilast1,
     &  pfirst0,pfirst1,plast0,plast1,
     &  direction, side,
     &  bdrytype,
...
c
c
      recursive subroutine adjnodediffusioncfoffdiag2d(
     &  ifirst0,ifirst1,ilast0,ilast1,
...
c
c
      recursive subroutine readjnodediffusionoffdiag2d(
     &  ifirst0,ifirst1,ilast0,ilast1,
     &  pfirst0,pfirst1,plast0,plast1,
     &  direction, side,
     &  stencil)
...
c
c
      recursive subroutine adjnodediffusioncfbdryrhs2d(
     &  ifirst0,ifirst1,ilast0,ilast1,
     &  pfirst0,pfirst1,plast0,plast1,
     &  direction, side,
     &  stencil,
