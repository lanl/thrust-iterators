...
c
c
      recursive subroutine celldiffusionv1res2d(
...
c
     ...
     &                    (flux1(ic1+1,ic0) - flux1(ic1,ic0))/dx(1))
            ...
            res(ic0,ic1) = f(ic0,ic1) - lu 
         enddo
      enddo
      return
      end
c
      recursive subroutine celldiffusionv2res2d(
     &  ifirst0,ilast0,ifirst1,ilast1,
     &  alpha,beta,
     &  dx,
     &  ugcw,
...
c
      recursive subroutine cellpoissonv1res2d(
     &  ifirst0,ilast0,ifirst1,ilast1,
     &  beta,
     &  dx,
     &  fgcw,
...
c
     ...
     &                  (flux1(ic1+1,ic0) - flux1(ic1,ic0))/dx(1))
      ...
      recursive subroutine celldiffusionv1apply2d(
     &  ifirst0,ilast0,ifirst1,ilast1,
     &  alpha,beta,
     &  dx,
     &  agcw,
...
c
      do ic1 = ifirst1, ilast1
         do ic0 = ifirst0, ilast0
            diver = beta*((flux0(ic0+1,ic1) - flux0(ic0,ic1))/dx(0) +
     &                    (flux1(ic1+1,ic0) - flux1(ic1,ic0))/dx(1))
            res(ic0,ic1) = - diver +alpha*acoef(ic0,ic1)*u(ic0,ic1)
         enddo
      enddo
      return
      end
c
      recursive subroutine celldiffusionv2apply2d(
     &  ifirst0,ilast0,ifirst1,ilast1,
     &  alpha,beta,
     &  dx,
     &  ugcw,
...
c
      do ic1 = ifirst1, ilast1
         do ic0 = ifirst0, ilast0
            diver = beta*((flux0(ic0+1,ic1) - flux0(ic0,ic1))/dx(0) +
     &                    (flux1(ic1+1,ic0) - flux1(ic1,ic0))/dx(1))
            res(ic0,ic1) = - diver +alpha*u(ic0,ic1)
         enddo
      enddo
      return
      end
c
      recursive subroutine cellpoissonv2apply2d(
     &  ifirst0,ilast0,ifirst1,ilast1,
     &  beta,
     &  dx,
     &  flux0,flux1, 
...
c
     ...
     &  ifirst0,ifirst1,ilast0,ilast1
      ...
      REAL dx(0:1)
      integer rgcw
      REAL res(CELL2d(ifirst,ilast,rgcw))
      REAL
     &  flux0(FACE2d0(ifirst,ilast,0)),
     &  flux1(FACE2d1(ifirst,ilast,0))
      integer ic0,ic1
...
c
      do ic1 = ifirst1, ilast1
        do ic0 = ifirst0, ilast0
         res(ic0,ic1)= -beta*((flux0(ic0+1,ic1) - flux0(ic0,ic1))/dx(0)+
     &                  (flux1(ic1+1,ic0) - flux1(ic1,ic0))/dx(1))
        enddo
      enddo
      return
