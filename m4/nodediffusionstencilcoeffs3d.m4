...
c
c  File:        nodediffusionstencilcoeffs3d.m4
...
c  Description: F77 routines that compute matrix entries for 3d node centered diffusion solver.
c
define(NDIM,3)dnl
...
c
c
      recursive subroutine nodediffusionoffdiag3d(
...
c     
      recursive subroutine nodepoissonoffdiag3d(
     &  ifirst0,ifirst1,ifirst2,
     &  ilast0,ilast1,ilast2,
     &  dx,
     &  beta,
...
c
c
      recursive subroutine nodediffusionv1diag3d(
     &  ifirst0,ifirst1,ifirst2,
     &  ilast0,ilast1,ilast2,
     &  ailo0,ailo1,ailo2,
     &  aihi0,aihi1,aihi2,
...
c
c     
      recursive subroutine nodediffusionv2diag3d(
     &  ifirst0,ifirst1,ifirst2,
     &  ilast0,ilast1,ilast2,
     &  alpha,
     &  stencil)
...
c
c     
      recursive subroutine nodepoissondiag3d(
     &  ifirst0,ifirst1,ifirst2,
     &  ilast0,ilast1,ilast2,
     &  stencil)
c***********************************************************************
...
c
c
      recursive subroutine adjnodediffusiondiag3d(
     &  ifirst0,ifirst1,ifirst2,
     &  ilast0,ilast1,ilast2,
...
c
        ...
        if (direction.eq.0) then
          ...
          if (side .eq. 0 ) then
            if(extrapOrder.eq.1) then
              ...
              do k = pfirst2, plast2
                do j = pfirst1, plast1
                  factor=beta*b0(edge,j, k)
                  factor=factor/h*(3.0*h+16.0*b0(edge,j,k))
        ...
        elseif (direction.eq.1) then
          ...
          if (side .eq. 0 ) then
            if(extrapOrder.eq.1) then
              ...
              do k = pfirst2, plast2
                do i = pfirst0, plast0
                  factor=beta*b1(edge,k,i)
                  factor=factor/h*(3.0*h+16.0*b1(edge,k,i))
        ...
        elseif (direction.eq.2) then
          ...
          if (side .eq. 0 ) then
            if(extrapOrder.eq.1) then
              ...
              do j = pfirst1, plast1
                do i = pfirst0, plast0
                  factor=beta*b2(edge,i,j)
                  factor=factor/h*(3.0*h+16.0*b2(edge,i,j))
      ...
      recursive subroutine adjnodepoissondiag3d(
     &  ifirst0,ifirst1,ifirst2,
     &  ilast0,ilast1,ilast2,
     &  pfirst0,pfirst1,pfirst2,
     &  plast0,plast1,plast2,
...
c
      ...
      recursive subroutine adjnodediffusioncfdiag3d(
     &  ifirst0,ifirst1,ifirst2,
     &  ilast0,ilast1,ilast2,
     &  pfirst0,pfirst1,pfirst2,
     &  plast0,plast1,plast2,
...
c
      recursive subroutine adjnodepoissoncfdiag3d(
     &  ifirst0,ifirst1,ifirst2,
     &  ilast0,ilast1,ilast2,
     &  pfirst0,pfirst1,pfirst2,
     &  plast0,plast1,plast2,
...
c
c
      recursive subroutine adjnodediffusionoffdiag3d(
     &  ifirst0,ifirst1,ifirst2,
     &  ilast0,ilast1,ilast2,
     &  pfirst0,pfirst1,pfirst2,
     &  plast0,plast1,plast2,
...
c
      recursive subroutine adjnodepoissonoffdiag3d(
     &  ifirst0,ifirst1,ifirst2,
     &  ilast0,ilast1,ilast2,
     &  pfirst0,pfirst1,pfirst2,
     &  plast0,plast1,plast2,
...
c
c
      recursive subroutine adjnodediffusioncfoffdiag3d(
     &  ifirst0,ifirst1,ifirst2,
     &  ilast0,ilast1,ilast2,
...
c
c
      recursive subroutine readjnodediffusionoffdiag3d(
     &  ifirst0,ifirst1,ifirst2,
     &  ilast0,ilast1,ilast2,
     &  pfirst0,pfirst1,pfirst2,
     &  plast0,plast1,plast2,
...
c
c
      recursive subroutine adjnodediffusioncfbdryrhs3d(
     &  ifirst0,ifirst1,ifirst2,
     &  ilast0,ilast1,ilast2,
     &  pfirst0,pfirst1,pfirst2,
     &  plast0,plast1,plast2,
