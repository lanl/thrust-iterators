...
c
c  File:        nodediffusionstencilcoeffs1d.m4
...
c  Description: F77 routines that compute matrix entries for 1d node centered diffusion operator
c
define(NDIM,1)dnl
...
c
c
      recursive subroutine nodediffusionoffdiag1d(
     &  ifirst0,ilast0,
     &  bilo0,bihi0,
     &  dx,
     &  beta,
...
c
     ...
     &  b0(FACE1d(bilo,bihi,0))
      ...
      REAL stencil(0:2, CELL1d(ifirst,ilast,0))
...
c     
      recursive subroutine nodepoissonoffdiag1d(
     &  ifirst0,ilast0,
     &  dx,
     &  beta,
     &  stencil)
...
c
c
      recursive subroutine nodediffusionv1diag1d(
     &  ifirst0,ilast0,
     &  ailo0,aihi0,
     &  alpha,
     &  a,
...
c
c     
      recursive subroutine nodediffusionv2diag1d(
     &  ifirst0,ilast0,
     &  alpha,
     &  stencil)
c***********************************************************************
...
c
c     
      recursive subroutine nodepoissondiag1d(
     &  ifirst0,ilast0,
     &  stencil)
c***********************************************************************
      implicit none
...
c
c
      recursive subroutine adjnodediffusiondiag1d(
     &  ifirst0,ilast0,
     &  pfirst0,plast0,
     &  side,
     &  bdrytype,
...
c
      ...
      recursive subroutine adjnodepoissondiag1d(
     &  ifirst0,ilast0,
     &  pfirst0,plast0,
     &  side,
     &  bdrytype,
...
c
      ...
      recursive subroutine adjnodediffusioncfdiag1d(
     &  ifirst0,ilast0,
     &  pfirst0,plast0,
     &  r,
     &  side,
...
c
      recursive subroutine adjnodepoissoncfdiag1d(
     &  ifirst0,ilast0,
     &  pfirst0,plast0,
     &  r,
     &  side,
...
c
c
      recursive subroutine adjnodediffusionoffdiag1d(
     &  ifirst0,ilast0,
     &  pfirst0,plast0,
     &  side,
     &  bdrytype,
...
c
      recursive subroutine adjnodepoissonoffdiag1d(
     &  ifirst0,ilast0,
     &  pfirst0,plast0,
     &  side,
     &  bdrytype,
...
c
c
      recursive subroutine adjnodediffusioncfoffdiag1d(
     &  ifirst0,ilast0,
     &  cfirst0,clast0,
     &  r,
     &  side,
...
c
c
      recursive subroutine readjnodediffusionoffdiag1d(
     &  ifirst0,ilast0,
     &  pfirst0,plast0,
     &  side,
     &  stencil)
...
c
c
      recursive subroutine adjnodediffusioncfbdryrhs1d(
     &  ifirst0,ilast0,
     &  pfirst0,plast0,
     &  side,
     &  stencil,
