...
c
c
      recursive subroutine nodediffusionv1apply3d(
...
c
      recursive subroutine nodediffusionv2apply3d(
     &  ifirst0,ilast0,
     &  ifirst1,ilast1,
     &  ifirst2,ilast2,
     &  alpha,beta,
      ...
      do k = ifirst2, ilast2
         do j = ifirst1, ilast1
            do i = ifirst0, ilast0
               diver = beta*((flux0(i+1,j,k) - flux0(i,j,k))/dx(0) +
     &                       (flux1(j+1,k,i) - flux1(j,k,i))/dx(1) +
     &                       (flux1(k+1,i,j) - flux1(k,i,j))/dx(2))
...
c
      recursive subroutine nodepoissonapply3d(
     &  ifirst0,ilast0,
     &  ifirst1,ilast1,
     &  ifirst2,ilast2,
     &  beta,
