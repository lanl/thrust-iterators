...
c
c
      recursive subroutine celldiffusionv1res1d(
     &  ifirst0,ilast0,
     &  alpha,beta,
     &  dx,
     &  agcw,
...
c
      recursive subroutine celldiffusionv2res1d(
     &  ifirst0,ilast0,
     &  alpha,beta,
     &  dx,
     &  ugcw,
...
c
      recursive subroutine cellpoissonv1res1d(
     &  ifirst0,ilast0,
     &  beta,
     &  dx,
     &  fgcw,
...
c
      ...
      recursive subroutine celldiffusionv1apply1d(
     &  ifirst0,ilast0,
     &  alpha,beta,
     &  dx,
     &  agcw,
...
c
      do ic0 = ifirst0, ilast0
         diver = beta*((flux0(ic0+1) - flux0(ic0))/dx(0))
         res(ic0) = - diver +alpha*acoef(ic0)*u(ic0)
      enddo

      return
      end
c
      recursive subroutine celldiffusionv2apply1d(
     &  ifirst0,ilast0,
     &  alpha,beta,
     &  dx,
     &  ugcw,
...
c
      do ic0 = ifirst0, ilast0
         diver = beta*((flux0(ic0+1) - flux0(ic0))/dx(0))
         res(ic0) = - diver +alpha*u(ic0)
      enddo

      return
      end
c
      recursive subroutine cellpoissonv2apply1d(
     &  ifirst0,ilast0,
     &  beta,
     &  dx,
     &  flux0,
...
c
      ...
      REAL dx(0:NDIM-1)
      integer rgcw
      REAL res(CELL1d(ifirst,ilast,rgcw))
      REAL flux0(FACE1d(ifirst,ilast,0))
      integer ic0
c
c***********************************************************************
c
      do ic0 = ifirst0, ilast0
         res(ic0) = -beta*((flux0(ic0+1) - flux0(ic0))/dx(0))
      enddo
