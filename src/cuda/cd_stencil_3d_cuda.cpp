                                    ...
                                    T* st_)
{
    ...
    auto st = make_vec(st_, sgcw, k, j, i, w);
    auto b0 = make_vec(b0_, bk, bj, bi + 1);
    auto b1 = make_vec(b1_, bi, bk, bj + 1);
    auto b2 = make_vec(b2_, bj, bi, bk + 1);
